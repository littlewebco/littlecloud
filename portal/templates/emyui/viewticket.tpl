    ...
    <div class="card view-ticket">
        <div class="card-body p-3 d-lg-flex justify-content-between">
                ...
                <div class="ticket-actions">
                    <button id="ticketReply" type="button" class="btn btn-primary rounded-20 ticket-actions-btns" onclick="smoothScroll('#ticketReplyContainer')">
                        <i class="fas fa-pencil-alt fa-fw"></i>
                        {lang key='supportticketsreply'}
                    </button>
                    {if $closedticket}
                        <button class="btn btn-danger rounded-20 ticket-actions-btns" disabled="disabled">
                            <i class="fas fa-times fa-fw"></i>
                            {lang key='supportticketsstatusclosed'}
                        </button>
                    {else}
                        <button class="btn btn-danger rounded-20 ticket-actions-btns" onclick="window.location='?tid={$tid}&amp;c={$c}&amp;closeticket=true'">
                            <i class="fas fa-times fa-fw"></i>
